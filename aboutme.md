...
hello, my name is Yves De Jesus. welcome to my site where i showcase my data work and side interests. i have extensive experience working with all types of structured _and_ unstructured data (with a focus on GIS data), some of which you can view here in the <a href="https://yvesmango.github.io/projects"> projects </a> section. 


currently available for full-time or contract work. previously worked as map specialist at National Grid. prior to that, i worked at a <a href="https://careshq.org/about/" target="_blank">GIS research center</a>, where i interacted with the ESRI suite to analyze and map spatial data, among many things between. my background is in science journalism, which is how i first broke through the data universe (data-verse?). 
