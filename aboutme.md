...
currently available for full-time or contract work. previously worked as map specialist at National Grid. prior to that, i worked at a <a href="https://careshq.org/about/" target="_blank">GIS research center</a>, where i transformed and mapped spatial data, among many things between. my background is in journalism, which is how i first broke through the data universe (data-verse?). 
