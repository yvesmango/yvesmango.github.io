...
currently looking for open roles. previously, i was a map technician at National Grid. prior to that i worked at a <a href="https://careshq.org/about/" target="_blank">GIS research center</a>, where i interacted with the ESRI suite to analyze and map spatial data, among many things between. my background is in science journalism, which is how i first broke through the data universe (data-verse?). 
