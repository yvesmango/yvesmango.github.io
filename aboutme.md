...
professionally, i work as a map specialist at national grid. my previous role at a <a href="https://careshq.org/about/" target="_blank">GIS research center</a> involved interacting with the ESRI suite to analyze and map spatial data, among many things between. my background is in journalism, which is how i first broke through the data universe (data-verse?). 
